...
\caption{Especificación de la Clase Sistema Parte 2 en VDM++. (Fuente: Archivo SistemaControlAcceso.vdmpp)}
...
\caption{Especificación de la Clase Sistema Parte 3 en VDM++. (Fuente: Archivo SistemaControlAcceso.vdmpp)}
\label{fig:clase_sistema_parte_3}
\end{figure}

\begin{figure}[ht]
\centering 
\includegraphics[width=0.8\columnwidth]{ClaseSistemaParte4.png} 
\caption{Especificación de la Clase Sistema Parte 4 en VDM++. (Fuente: Archivo SistemaControlAcceso.vdmpp)}
\label{fig:clase_sistema_parte_4}
\end{figure}
